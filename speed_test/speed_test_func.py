...
def test_access(isp):
    ...
    if isp.lower() == 'nos':
        try:
            ...
            time.sleep(80)
        except webdriver.Error as error:
            print("Failed to start chromeless!")
    else:
        None  # it will have another isp here!


test_access(input('(nos/meo/vodafone): '))
...
insert_values(dict_test["id"], dict_test["Data"], dict_test["Browser"],
